...
def screen_init(width=2400, height=00, t=turtle):
...
def draw_ui(t):
    write_txt(-200, 250, "Autonomous Robot Live Position", "black",  t, f=('Arial', 32, 'normal'))
    fill_rect(-400, 200, 800, 40, "black", t)
    write_txt(-80, 205, "Innovation Center", "yellow",  t, f=('Arial', 24, 'normal'))
